<script src="/static/js/acct/freezingDaily.js" charset="utf-8"></script>
<div class="easyui-layout" fit="true">
    <div data-options="region:'north',border:false" style="height: 50px;padding: 10px;">
        <form id="acct_freezingDaily_search_from" class="searcher-form">
            <table>
                <tr>
    ...
    <div data-options="region:'center',border:false" style="border-top: 1px solid #D3D3D3">
        <table id="acct_freezingDaily_dg"></table>
    </div>
</div>