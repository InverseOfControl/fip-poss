        ...
        <form id="acct_pipeLog_search_from" class="searcher-form">
            <table>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <input name="beginAccountingDay" class="easyui-datebox field" label="会计日期：" labelWidth="80" style="width: 210px;" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"/>
                        <input name="endAccountingDay" class="easyui-datebox field" label="-" labelWidth="10" style="width:130px; " onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"/>
                    </td>
                    <td colspan="3">
