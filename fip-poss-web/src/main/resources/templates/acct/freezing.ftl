<script src="/static/js/acct/freezing.js" charset="utf-8"></script>
<div class="easyui-layout" fit="true">
    <div data-options="region:'north',border:false" style="height: 80px;padding: 10px;">
        <form id="acct_freezing_search_from" class="searcher-form">
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <!--
                    <td colspan="2">
                        <input name="openStartTime" class="easyui-datebox field" label="开户日期：" labelWidth="80" style="width: 210px;" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
                        <input name="openEndTime" class="easyui-datebox field" label="-" labelWidth="10" style="width:130px; " onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
                    </td>
                    -->
                    <td colspan="3">
    ...
    <div data-options="region:'center',border:false" style="border-top: 1px solid #D3D3D3">
        <table id="acct_freezing_dg"></table>
    </div>
</div>