<script src="/static/js/paycore/payDirective.js" charset="utf-8"></script>
<div class="easyui-layout" fit="true">
    <div data-options="region:'north',border:false" style="padding: 10px;">
        <form id="pay_directive_form" class="searcher-form">
            <table>
                <tr>
                    <td><input name="orgCode" class="easyui-textbox" label="渠道号" labelWidth="70" style="width: 240px;"/></td>
                    <td><input id="transType" name="tradeType" class="easyui-combobox" label="交易类型" labelWidth="70" style="width: 220px;"/></td>
                    <td><input id="bizStatus" name="payStatus" class="easyui-combobox" label="支付状态" labelWidth="70" style="width: 200px;"/></td>
                ...
                <tr>
                    ...
                    <td><input name="directiveId" class="easyui-textbox" label="支付指令号" labelWidth="70" style="width: 220px;"/></td>
                    ...
                    <td colspan="3">
                        <input name="tradeDateBegin" label="交易日期" labelWidth="70" style="width: 200px;"/>
    ...
    <div data-options="region:'center',border:false" style="border-top: 1px solid #D3D3D3">
        <table id="pay_directive_dg"></table>
    </div>
</div>
<div id="tempDiv"></div>