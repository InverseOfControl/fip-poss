<script src="/static/js/acct/adjustAudit.js" charset="utf-8"></script>
<div class="easyui-layout" fit="true">
    <div data-options="region:'north',border:false" style="height: 80px;padding: 10px;">
        <form id="acct_adjustAudit_search_from" class="searcher-form">
            <table>
                <tr>
    ...
    <div data-options="region:'center',border:false" style="border-top: 1px solid #D3D3D3">
        <table id="acct_adjustAudit_dg"></table>
    </div>
</div>